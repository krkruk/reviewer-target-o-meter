...
- [x] 6.1 `make check` clean; workflow yaml parses (`yaml.safe_load` / `actionlint`)
- [x] 6.2 `make test` unaffected — new consumer smoke test skipped without `SMOKE=1`
- [x] 6.3 `SMOKE=1 OPENROUTER_API_KEY=… make llm-test` green incl. new consumer smoke test
